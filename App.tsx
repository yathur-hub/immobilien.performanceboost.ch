  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
      ...
      <header className="glass border-b border-slate-200/60 sticky top-0 z-50 transition-all duration-300">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3">
               ...
               <a
                ...
                className="hidden md:block bg-slate-900 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-slate-800 transition-all shadow-md hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 whitespace-nowrap"
               >
                 Erstberatung
               </a>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 w-full bg-white/95 backdrop-blur-xl border-b border-slate-200 shadow-xl animate-fade-in z-40">
...
const Logo: React.FC<{ className?: string }> = ({ className = "" }) => (
  <img 
    ...
    className={`h-[75px] w-auto object-contain transition-transform duration-300 hover:scale-105 ${className}`}
  />
);
  ...
  return (
    <div className="space-y-24 pb-12">
      ...
      <section className="relative text-center max-w-5xl mx-auto pt-8">
        ...
        <p className="text-xl text-slate-600 leading-relaxed mb-10 max-w-4xl mx-auto font-medium">
          Projektwebseite und Kampagnenperformance ab Tag 1 integriert.<br />
